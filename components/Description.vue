<template>
  <div>
    ...
    <div class="content">
      <ol type="1">
        <li>What are some of the most crazy and expensive airbnb listings in NYC?</li>
        <li>How do airbnb's average prices changes depending on how close they are to popular landmarks?</li>
